-- MySQL compatible schema for local development
-- For Render/PostgreSQL deployment, use schema-pgsql.sql
...
-- 索引（MySQL 不支持 IF NOT EXISTS，用 INSERT IGNORE 风格的分号跳过错误）
-- 索引已在表的 UNIQUE / FOREIGN KEY 中部分覆盖，以下为可选优化
